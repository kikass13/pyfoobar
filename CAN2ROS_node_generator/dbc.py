...
def decodeMsgMultiQuery(content, packagename, messageList, specifications, rulesets):
	output_strings = []
...
def autoFillH(packagename, messageList, msg_specifics, rulesets):
	...
	files = glob.glob("%s/*.h" % headerFilePath)
...
def openConfiguration(configFilePath):
	...
	databaseFile = dataDict.get("database", None)
